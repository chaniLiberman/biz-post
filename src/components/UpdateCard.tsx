...
const UpdateCard: FunctionComponent<UpdateCardProps> = () => {
    ...
    return (
        <>
         <h5 className="display-1 text-center">Update Card</h5>
            <div className="container col-md-6 mt-5 pb-3 input backGround">
                <form className="row g-3 p-2" onSubmit={formik.handleSubmit} >
                    ...
                    <button disabled={!formik.isValid || !formik.dirty} className="btn btn-primary mb-2 w-100" type="submit" style={{ background: "#947427", border: "#947427" }}>Update</button>
                </form>
                <button className="btn btn-danger w-100" onClick={() => navigate(-1)}>CANCLE</button>
